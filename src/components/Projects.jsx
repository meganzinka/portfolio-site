					...
					{project === 'Ad-Magic' ? (
						<div>
							...
							<div id="project-description">
								...
								<b>Sprint:</b> 3 weeks
								<br />
								<b>Description:</b> An Executive Sales Dashboard created from scratch which hosts a
								variety of filter tools. All tools are responsive to real-time database updates and user
								input. My principal role in the project was to design and create the filtering tool from
								back to front end, set up database queries, and create hand-rolled styling.
								<br />
								<b>Technologies used:</b> React, Javascript, CSS, HTML, React Apex Charts, React
								Leaflet, ExpressJS, NodeJS, MongoDB
