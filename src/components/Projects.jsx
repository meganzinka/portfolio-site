			...
			<div id="projects-container">
				<div id="ad-magic" className="project">
					...
					<div className="project-description">
						Dashboard created from scratch which hosts many ways to filter sales. All tools are
						responsive to database updates and user input. My principal role in the project was to create the filtering tool from back to front end, set up database queries, and create
						hand-rolled styling.<br />
						<br />
						React | Javascript | CSS | HTML | ExpressJS | NodeJS | MongoDB | Apex Charts
				...
				<div id="til" className="project">
					...
					<div className="project-description">
						Web-server and front-end application built to mimic the "Today I Learned" SubReddit. Features
						include adding a new entry, searching by tag, editing and deleting entries, and reference
						various pieces of information that the user learned. Each entry includes a title, subject, content, link, and tag. 
						<br />
						<br />
				...
				<div id="geo-vt" className="project">
					...
					<div className="project-description">
						Web-server and front-end game application developed to drop the player at a random location
						within Vermont and require the player to guess which county they are in using minimal moves. The user can move north, east, south, west, return to the original
						location, guess the county, and receive a message about the accuracy of the guess.
						<br />
						<br />
						React | Javascript | CSS | HTML | ExpressJS | NodeJS | MongoDB
						<a target="_blank" href="https://github.com/meganzinka/today-I-learned">
				...
				<div id="yelp" className="project">
					...
					<div className="project-description">
						Yelp-like app created to enable users to view and learn about restaurants in Provincetown.
						Features include zooming into a restaurant's location upon choosing a restaurant, viewing core info
						about the business, and leaving and viewing comments.<br />
						<br />
